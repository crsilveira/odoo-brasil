...
CST_IBSCBS = [
    ('000001', u'000-001 Tributação integral'),
    ('200001', u'200-001 Alíq. zero - Empresas zonas exportação'),
    ('200002', u'200-002 Alíq. zero - Forn. para produtor, maq. e eq.'),
    ('200003', u'200-003 Alíq. zero - Produtos dest. alimentaçao'),
    ('200013', u'200-013 Alíq. zero - Tampões hig., absorventes'),
    ('200014', u'200-014 Aliq. zero - Forn. hortícols, frutas e ovos'),
    ('200034', u'200-034 Aliq. red. 60% - Alimentos humanos - anexo VII'),
    ('200035', u'200-035 Aliq. red. 60% - Alimentos limpeza - anexo VIII'),
    ('200036', u'200-036 Aliq. red. 60% - Agropecuários, aquícolas, pesqueiros e outros'),
    ('200037', u'200-037 Aliq. red. 60% - Serviços ambientais ou recupeção vegetal'),
    ('200038', u'200-038 Aliq. red. 60% - Insumos agrop e aquícolas - anexo IX'),
    ('200047', u'200-047 Aliq. red. 40% - Bares e restaurantes'),
    ('410001', u'410-001 Imun. e não incid. - Bonificaçao art. 5.'),
    ('410002', u'410-002 Imun. e não incid. - Transf. entre estab. mesmo contrib.'),
    ('410003', u'410-003 Imun. e não incid. - Doações sem contraprestação'),
    ('410004', u'410-004 Imun. e não incid. - Exportação de bens e serviços'),
    ('410014', u'410-014 Imun. e não incid. - Produtor rural até 3,6'),
    ('410999', u'410-999 Imun. e não incid. - Operações não onerosas outras'),
    ('515001', u'515-001 Difer. red. aliq. - Insumos agrop., e aquícolas'),
    ('550001', u'550-001 Suspensão - Exportação de bens materiais'),
]
